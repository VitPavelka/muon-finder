...
def main() -> None:
    ...
    print(f"mask cleanup intervals tested: {summary.get('mask_intervals_tested', 0)}")
    print(f"mask cleanup candidates tested: {summary.get('mask_cleanup_candidates_tested', 0)}")
    print(f"mask cleanup corrected: {summary.get('mask_cleanup_corrected', 0)}")
    print(f"mask cleanup rejected below noise height: {summary.get('mask_cleanup_rejected_below_noise_height', 0)}")
